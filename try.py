...
num1=int(input("number 1 : -Please enter a number between 1-999-"))
num2=int(input("number 2 : - Please enter a number between 1-number1 "))
...
for i in range(8):
    userNumber = int(input("Please enter a number between 3-7 for creating password "))
    random_choices = random.sample(words,userNumber)
   #print(random_choices)
    random_choices = ''.join(random_choices)
   #print(random_choices)
    my_password = random_choices[::-1]
    print("password : "  ":" + my_password)



    if userNumber < 5:
        short_set.add(my_password)
    else:
        long_set.add(my_password)

    combined_set = short_set.union(long_set)
    print("Combined set: ", combined_set)

print("--------------------------------------------------------------------------------------------------------------")
d = {i: i*(i-1) for i in range(1, 31)}
...
try:
    ...
    print(num, "not found in dictionary.")
